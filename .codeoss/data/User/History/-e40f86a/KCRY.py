...
# ==========================================
# 1. CONFIGURATION (DUAL BOT SETUP)
# ==========================================

# We now have TWO Telegram Tokens
...
def send_sos(user_id, text, override_gid=None):
    # SOS ALERTS NOW GO THROUGH THE GUARDIAN BOT!
...
def handle_text_main(chat_id, text):
    ...
    # Button Handlers (Removed the Change Guardian button to keep it simple)
...
# ==========================================
# 3. AI SCANNERS (Unchanged, just using the new get_api_url helper for downloading files)
# ==========================================
